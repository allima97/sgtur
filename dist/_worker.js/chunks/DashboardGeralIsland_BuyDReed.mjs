...
import { j as jsxRuntimeExports, s as supabase } from './systemName_EsfuoaVO.mjs';
...
const DashboardGeralIsland = () => {
  ...
  const vendasTimeline = reactExports.useMemo(() => {
    ...
    const arr = Array.from(map.entries()).sort(([a], [b]) => a < b ? -1 : 1).map(([date, value]) => {
      ...
      const label = year && month && day ? `${day.padStart(2, "0")}/${month.padStart(2, "0")}` : date;
  ...
  const renderPieLegendList = (data) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexDirection: "column", gap: 8 }, children: data.map((entry, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontWeight: 600, color: "#0f172a" }, children: entry.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "#475569" }, children: formatCurrency(Number(entry.value || 0)) })
      ] })
    ] }, `${entry.name}-${idx}`)) });
  };
