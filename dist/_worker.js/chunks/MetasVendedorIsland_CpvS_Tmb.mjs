...
import { s as supabase, j as jsxRuntimeExports } from './supabase_Di0qno_D.mjs';
...
function MetasVendedorIsland() {
  ...
  async function carregarDados() {
    try {
      ...
      setUsuario(logado);
      const { data: produtosData } = await supabase.from("produtos").select("id, nome").eq("ativo", true);
  ...
  if (loading) return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Carregando..." });
  if (!ativo) return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Acesso ao módulo de Metas bloqueado." });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "metas-vendedor-page", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-row", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2", children: [
            metaProdutos.map((mp, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-row", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "form-group", style: { justifyContent: "flex-end" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
