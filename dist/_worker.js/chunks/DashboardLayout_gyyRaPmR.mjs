...
import { c as createComponent, a as createAstro, e as renderHead, f as renderComponent, r as renderSlot, d as renderTemplate } from './astro/server_CVPGTMFc.mjs';
/* empty css                              */
import { s as supabase, j as jsxRuntimeExports, S as SYSTEM_NAME } from './systemName_EsfuoaVO.mjs';
import { r as reactExports } from './_@astro-renderers_lNEyfHhP.mjs';
import { r as registrarLog } from './logs_By9JfuIz.mjs';
...
const FornecedoresIcon = () => /* @__PURE__ */ jsxRuntimeExports.jsxs(
  "svg",
  {
    width: "20",
    height: "20",
    ...
    focusable: "false",
    children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "14", cy: "8", r: "4.2" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M9 18c0-1.5 1.7-3 5-3s5 1.5 5 3" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M8 25c1.5-3 6-4 8-4s6 1 7 4" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "11.5", y: "19", width: "6", height: "4", rx: "1" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M21.5 8v16" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M21.5 8l6 3-6 3" })
    ]
  }
);
function MenuIsland({ activePage }) {
  ...
  async function carregar() {
    ...
    const { data, error } = await supabase.from("modulo_acesso").select("modulo, permissao, ativo").eq("usuario_id", uid);
    if (error) {
      setCacheLoaded(true);
      return;
    }
    ...
    (data || []).forEach((r) => {
      ...
      const permVal = perm === "admin" || perm === "delete" || perm === "edit" || perm === "create" || perm === "view" ? perm : "none";
  ...
  const cadastrosMenu = [
    ...
    { name: "Produtos", href: "/cadastros/produtos", active: "produtos", icon: "🎫", label: "Produtos" },
    {
      ...
      active: "fornecedores",
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(FornecedoresIcon, {}),
      label: "Fornecedores"
    }
  ];
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sidebar-mobile-icon", children: mobileOpen ? "✕" : "☰" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: mobileOpen ? "Fechar" : "Menu" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `sidebar-overlay ${mobileOpen ? "visible" : ""}`, onClick: closeMobile })
    ] }),
    document.body
  ) : null;
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { id: sidebarId, className: `app-sidebar ${mobileOpen ? "open" : ""}`, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "sidebar-nav", children: [
          ...
          can("Comissionamento") && /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
          ...
          isAdminFinal && /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
      ...
      isAdminFinal && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
...
export { $$DashboardLayout as $, reactDomExports as r };
