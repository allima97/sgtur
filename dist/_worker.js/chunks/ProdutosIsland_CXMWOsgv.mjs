  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "destinos-page", children: [
    ...
    mostrarFormulario && formLayout !== "selection" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card-base card-blue mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: salvar, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-row", style: { marginTop: 12 }, children: [
        ...
        !isGlobalMode && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", style: { flex: 1, minWidth: 200 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "form-label", children: "Todas as cidades" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "select",
              {
      ...
      !isGlobalMode && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-row", style: { marginTop: 12 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-row", style: { marginTop: 12 }, children: [
        !isGlobalMode && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", style: isGlobalMode ? { flex: 1 } : void 0, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "table-container overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "table-default table-header-blue min-w-[1080px]", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
        loading && /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 8, children: "Carregando produtos..." }) }),
        !loading && produtosFiltrados.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 8, children: "Nenhum produto encontrado." }) }),
