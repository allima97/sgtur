...
function RelatorioAgrupadoClienteIsland() {
  ...
  function exportarExcel() {
    ...
    utils.book_append_sheet(wb, ws, "Vendas por Cliente");
    const ts = (/* @__PURE__ */ new Date()).toISOString().replace(/[-:T]/g, "").slice(0, 12);
    writeFileSync(wb, `relatorio-clientes-${ts}.xlsx`);
  }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relatorio-vendas-cliente-page", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "table-container overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "table-default table-header-purple table-mobile-cards min-w-[700px]", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
        ...
        !loading && linhas.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { "data-label": "Cliente", children: l.cliente_nome }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { "data-label": "CPF", children: l.cliente_cpf }),
