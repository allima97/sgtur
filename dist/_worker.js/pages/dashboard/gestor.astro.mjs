...
import { R as ResponsiveContainer, L as LineChart, X as XAxis, Y as YAxis, T as Tooltip, a as Line } from '../../chunks/LineChart_BXJtniqq.mjs';
...
-->${renderComponent($$result, "DashboardLayout", $$DashboardLayout, { "title": "Dashboard do Gestor" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section style="
      ...
      max-width: 1300px;
      margin: 0 auto;
    "> ${renderComponent($$result2, "DashboardGestorIsland", DashboardGestorIsland, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/Users/allima97/Documents/GitHub/sgtur/src/components/islands/DashboardGestorIsland.tsx", "client:component-export": "default" })} </section> ` })}`;
