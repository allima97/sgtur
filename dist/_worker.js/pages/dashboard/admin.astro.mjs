...
const $$Admin = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`<!-- Apenas ADMIN deve acessar — middleware + island verificam isso -->${renderComponent($$result, "DashboardLayout", $$DashboardLayout, { "title": "Dashboard Administrativo" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section style="
      ...
      max-width: 1300px;
      margin: 0 auto;
    "> ${renderComponent($$result2, "DashboardAdminIsland", DashboardAdminIsland, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/Users/allima97/Documents/GitHub/sgt-astro/src/components/islands/DashboardAdminIsland.tsx", "client:component-export": "default" })} </section> ` })}`;
}, "/Users/allima97/Documents/GitHub/sgt-astro/src/pages/dashboard/admin.astro", void 0);

const $$file = "/Users/allima97/Documents/GitHub/sgt-astro/src/pages/dashboard/admin.astro";
