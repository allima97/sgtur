...
const _page12 = () => import('./pages/cadastros/paises.astro.mjs');
const _page13 = () => import('./pages/cadastros/produtos.astro.mjs');
const _page14 = () => import('./pages/clientes/carteira.astro.mjs');
const _page15 = () => import('./pages/comissoes/fechamento.astro.mjs');
const _page16 = () => import('./pages/dashboard/admin.astro.mjs');
const _page17 = () => import('./pages/dashboard/gestor.astro.mjs');
const _page18 = () => import('./pages/dashboard/logs.astro.mjs');
const _page19 = () => import('./pages/dashboard/permissoes.astro.mjs');
const _page20 = () => import('./pages/dashboard.astro.mjs');
const _page21 = () => import('./pages/documentacao.astro.mjs');
const _page22 = () => import('./pages/gestor/importar-vendas.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/cadastros/paises.astro", _page12],
    ["src/pages/cadastros/produtos.astro", _page13],
    ["src/pages/clientes/carteira.astro", _page14],
    ["src/pages/comissoes/fechamento.astro", _page15],
    ["src/pages/dashboard/admin.astro", _page16],
    ["src/pages/dashboard/gestor.astro", _page17],
    ["src/pages/dashboard/logs.astro", _page18],
    ["src/pages/dashboard/permissoes.astro", _page19],
    ["src/pages/dashboard/index.astro", _page20],
    ["src/pages/documentacao/index.astro", _page21],
    ["src/pages/gestor/importar-vendas.astro", _page22],
